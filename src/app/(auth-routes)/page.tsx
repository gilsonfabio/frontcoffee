...
export default function Home() {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center md:justify-between w-screen h-screen">
      <div className="flex flex-col bg-gray-300 items-center justify-center w-full h-screen">
